...
impl TxInfo for CreateSubAccountTx {
    fn get_tx_type(&self) -> u8 { TX_TYPE_L2_CREATE_SUB_ACCOUNT }
    ...
    fn hash(&self, chain_id: u32) -> Result<Vec<u8>, TxError> {
        ...
        elems.push(GoldilocksField(TX_TYPE_L2_CREATE_SUB_ACCOUNT as u64));
